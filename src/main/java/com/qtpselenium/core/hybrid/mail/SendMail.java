...
import java.util.*;
//this isusefull for sending the emails add javax.mail dependency in pom.xml
//put the path of extentreport in projectproperties
...

{
...

    {
        ...
        //date
         ...
         // mail extent reports
                String[] to={"leena.kapgate@gmail.com"};
